...
label ds:
    ...
    if not student:
        ...
        scene bg koledsh
        with fade    
        "Текст: {i}Колледж имени Санька Морозова{/i}"
        show pm talk at left
    ...
    menu kudaidti:
        "Библиотека":
            ...
            menu asdghd:
                ...
                "Кирилл" if win_4les or not talk_2kirill and talk_1kirill:
                    ...
                    "Нажмите что бы продолжить"
                    jump asdghd
                "Тянка" if tank_2tank and not tank_3tank:
                    $ tank_3tank = True
                    show tank
                    with dissolve
                    t "Я пришла сюда"
                ...
                "Санёк" if not first_libriary and first_pola or win_1les and not talk_1sanek or win_2les and not talk_2sanek or win_1dan and not talk_4sanek or win_2dan and not talk_5sanek or win_4dan and not talk_6sanek:
                    ...
                    if win_2les and not talk_2sanek:
                        ...
                        scene bg koledsh_class
                        jump asdghd
                    if win_4dan and not talk_4sanek:
                        $ talk_4sanek = True
                        show px
                        with dissolve
                        x "Вы снова пришли"
        ...
        "Комната":
            ...
            menu asdaghd:
                # ИЗМЕНИТЬ
                "Общий сбор" if not talk_3kirill and win_2dan and talk_3boris:
                ...
                "Саша" if win_1dan and not talk_1sasha:
                    $ talk_1sasha = True
                    show ps
                    with dissolve
                    s "Что же"
...
label most:
    ...
    if talk_1denis and random_choise(15):
    ...
    menu mostm:
        "Любимый" if win_2les and not talk_2sanek and talk_1maxim:
            $ talk_2maxim = True
            show pl cool at left
...
label shop:
    ...
    if not student:
        ...
        ''
    if game_time > 18:
        if talk_1boris and action_1tank and not tank_2tank and win_3les:
            $ tank_2tank = True
            scene bg shop
            with fade
    ...
    menu shop_bar:
        ...
        "Тарас" if game_time == 12 and barmen:
            ...
            if not talk_2tank and not action_1tank:
                z "Прийди ночью в магазин Бориса"
            if not talk_1denis:
                z "Продолжай пиздить Дениса пока он спит"
            if not tank_3tank and not action_1tank:
...
label daun:
    ...
    if talk_2maxim and talk_1boris and otpizdeli_denisa >= 3 and game_time == 24:
        $ talk_1denis = True
        scene black
        pause(1.0)
        show pd aun
    ...
    if not win_4dan and not talk_6sanek and not talk_5boris and not talk_3tank and not talk_3sasha and not talk_4maxim and not talk_2taras:
