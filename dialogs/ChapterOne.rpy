label deadw:
    ...
    with vpunch
    voice u0002
    $ addDictionary("Бог Юй", "Великое божество которое управляем миром, отсеивает педофилов и другх в Ад или Рай.")
...
label ad:
    ...
    pause(1.0)
    "ПРЕДУПРИЖДЕНИЕ" "Дальше игра будет идти по другой сужетной линии,а"
...
label ray_dev:
    menu gg:
        ...
        "Саша - Главный герой":
            ...
            $ img_player = "sasha"
            $ a.name = name
            $ a.skills={"старт":doubleattack,"предмет":None,"свиток":None}
            $ friend = "maks"
            $ a.hpmax = 30
            $ party_list = [maks]
        ...
        "Макс - Главный герой":
            ...
            $ a.name = name
            $ friend = "sasha"
            $ a.skills={"старт":circleofhealing,"предмет":None,"свиток":None}
            $ a.hpmax = 25
            $ party_list = [sasha]
