...
screen about():
    ...
    use game_menu(_("Об игре"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("{b}Обновление 1.7!{/b}\nКрупное обновление\n\nОдни из самых главных нововведений:\n- Озвучка всех персонажей 11 гласами(Макс, Саша, Денис, Кирилл, Аня, Санёк, Катя, Борис, Максим, Тарас, Рома)- \nТак же было добавлено очень много контента, такого как End Game - новые диалоги новые концовки и т.д. при втором прохождении из это можно узнать больше лора\n- Переделан ВЕСЬ интерфейс\n- Добавлен выбор сложности\n- Секретный контент\n\nВизуальная новела про поход в школу, много кринжа и пиздеца.\n\nВ этой игре на renpy было сделано RPG и связь с дискордом, так что многие действия будут отправлены в дискорд\n\nВ будущем планируется сделать около 4 глав с законченной историей, на данный момент готова первая глава про путешествие в загробном мире.")
